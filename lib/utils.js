...
// Format date — short for score cards
...
// Sport config
export const SPORTS = {
  nba: { name: "NBA", color: "#c9082a", icon: "🏀", slug: "nba" },
  nfl: { name: "NFL", color: "#013369", icon: "🏈", slug: "nfl" },
  mlb: { name: "MLB", color: "#002d72", icon: "⚾", slug: "mlb" },
};
